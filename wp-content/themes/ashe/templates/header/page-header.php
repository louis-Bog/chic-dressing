			...
			<div class="cv-inner">
				<div class="header-logo">
					...
					?>
						...
						<a aria-label="Chic href=" <?php echo esc_url(home_url('/')); ?>" title="<?php esc_attr(bloginfo('name')); ?>" class="logo-img">
					...
					<?php else : ?>
						...
						<?php if (is_home() || is_front_page()) : ?>
							<h1>
								<a aria-label="Chic href=" <?php echo esc_url(home_url('/')); ?>" class="header-logo-a"><?php echo bloginfo('title'); ?></a>
							</h1>
						<?php else : ?>
							<a aria-label="Chic href=" <?php echo esc_url(home_url('/')); ?>" class="header-logo-a"><?php echo bloginfo('title'); ?></a>
						<?php endif; ?>
