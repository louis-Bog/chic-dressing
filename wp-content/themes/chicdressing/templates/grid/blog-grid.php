	...
	?>
				<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
					...
					<div class="post-media">
						<a aria-label="Chic Dressing" href="<?php echo esc_url(get_permalink()); ?>"></a>
					...
					<header class="post-header">
						...
						<?php if (get_the_title()) : ?>
							<h2 class="post-title">
								<a aria-label="Chic Dressing" href="<?php esc_url(the_permalink()); ?>"><?php the_title(); ?></a>
							</h2>
						<?php endif; ?>
					...
					<div class="read-more">
						<a aria-label="Chic Dressing" href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e('read more', 'ashe'); ?></a>
					</div>
					...
					<footer class="post-footer">
						...
						<?php if (ashe_options('blog_page_show_author') === true) : ?>
							<span class="post-author">
								<a aria-label="Chic Dressing" href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename'))); ?>">
