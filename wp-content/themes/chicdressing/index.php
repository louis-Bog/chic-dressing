...
?>
	<div id="chic-products" class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Nos pièces de créateur à prix cassé</h2>
		<?php
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">Nos marques de luxe</h2>
		<iframe title="GoogleMap" src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480"></iframe>';
	</div>
<?php
